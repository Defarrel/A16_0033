...
import com.example.gloycash.ui.viewmodel.pengeluaran.toPengeluaran
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Pengeluaran: ${pengeluaran.total.toInt()}",
                    fontSize = 18.sp,
            ...
            ComponentDetailPengeluaran(
                ...
                judul = "ID Kategori",
                isinya = pengeluaran.idKategori.toString(),
            )
            ComponentDetailPengeluaran(
                icon = Icons.Filled.Info,
                judul = "ID Aset",
                isinya = pengeluaran.idAset.toString(),
            )
            ComponentDetailPengeluaran(
                icon = Icons.Filled.DateRange,
                judul = "Tanggal Transaksi",
                isinya = pengeluaran.tanggalTransaksi,
            )
            ComponentDetailPengeluaran(
                icon = Icons.Filled.Info,
                judul = "Catatan",
                isinya = pengeluaran.catatan,
            )
        }
    }
